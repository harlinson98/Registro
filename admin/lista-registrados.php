    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Administrar la lista de los registrados</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                 ...
                 try {
                   ...
                   while($registrados = $resultado->fetch_assoc() ) { ?>
                       <tr>
                             ...
                             <td><?php echo $registrados['fecha_registrado']; ?></td>
                             <td>
                               <?php
                              $articulos = json_decode($registrado['pases_articulo'], true);
                             ...
                             <td>$ <?php echo $registrados['total_pagado']; ?></td>
                               ...
                               <td>
                                  ...
                                  <a href="editar-registro.php?id=<?php echo $registrado['ID_Registrado']; ?>" class="btn bg-maroon btn-flat margin">
                                   <i class="fa fa-pencil"></i>
                                  </a>
