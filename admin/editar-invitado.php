              ...
              <form role="form" name"guardar-registro"  id="guardar-registro-archivo" method="post" action="modelo-invitado.php" enctype="multipart/form-data">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="apelliso_invitado" name="apelliso_invitado" placeholder="Apellido."  value="<?php echo $invitado['apellido_invitado']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="biografia_invitado">Biografia</label>
                    <textarea  class="form-control" id="biografia_invitado" name="biografia_invitado" rows="8" cols="80" placeholder="Biografia"><?php echo $invitado['descripcion']; ?>"</textarea>
                  </div>
                  <div class="form-group">
                ...
                <div class="box-footer">
                  ...
                  <button type="submit" class="btn btn-primary" id="crear_registro_admin">Actuaizar</button>
                </div>
              </form>
        </div>
        <!-- /.box-body -->
