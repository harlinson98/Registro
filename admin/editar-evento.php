...
if(!filter_var($id, FILTER_VALIDAR_INT)):
  die("error");
else:
 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      EDITAR EVENTO
        <small>Diligenciar el formulario para editar un EVENTO</small>
      </h1>
    </section>
  <div class="row">
      <div class="col-md-8">
                      ...
                      <option value="0">--Seleccione--</option>
                        <?php
                              try{
                                ...
                                $resultado = $conn->query($sql);
                                while($cat_evento = $resultado->featch_assoc()) { ?>
              ...
              <option value="0">--Seleccione--</option>
                <?php
                      try{
                        ...
                        $resultado = $conn->query($sql);
                        while($invitados = $resultado->featch_assoc()) {
